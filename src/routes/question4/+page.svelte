...
{#if happy}
<div class= "buttonContainer" transition:fade={{duration: 1000}}><button on:click={()=>goto('/question5')}>To the next quest</button></div>
{/if}



<img class:sad class:moresad alt="Hannes is angry" src={photos?.get("krise.png")} />
